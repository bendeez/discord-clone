...
from app.schemas.websocket_data.websocket_data import (
    WebsocketData,
...
class ServerConnectionManager:
    ...
    async def connect(
        self, websocket: WebSocket, current_user: WebsocketConnection
    ):
    ...
    async def broadcast_dm(
        ...
        ):  # checks if the dm id is a part of the user's dms
            """
