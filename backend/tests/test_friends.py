...
async def test_create_friend(
    http_request, current_user_token, current_user, remote_user, db
):
...
async def test_invalid_create_friend_by_being_sender(
    http_request, current_user, remote_user, db
):
...
async def test_invalid_create_friend_by_already_friends(
...
async def test_invalid_create_friend_by_no_friend_request(
