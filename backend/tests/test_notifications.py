...
from app.notification.service import get_notification_by_dm_id
...
async def test_get_notification(
    ...
    response = await http_request(
        "/notification", method=RequestMethod.GET, token=current_user_token
    )
...
async def test_delete_notfication(
    http_request,
    current_user,
    current_user_token,
    websocket_connection,
