...
def upgrade() -> None:
    ...
    op.create_unique_constraint(None, "dm", ["sender", "receiver"])
    op.create_unique_constraint(None, "friendrequests", ["sender", "receiver"])
    op.create_unique_constraint(None, "friend", ["sender", "receiver"])
    op.create_unique_constraint(None, "notification", ["sender", "receiver"])
    ...
    op.create_foreign_key(
        None, "server_user", "server", ["server_id"], ["id"], ondelete="CASCADE"
    )
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        "server_user_server_id_fkey", "server_user", "server", ["server_id"], ["id"]
    )
    ...
    op.drop_constraint(None, "dm", type_="unique")
    # ### end Alembic commands ###
