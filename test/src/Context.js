...
export default function ContextProvider(props){
    ...
    async function getUserInformation(){
            let url = "http://127.0.0.1:8000/usercredentials"
            let requestOptions = {
                  method: 'GET',
    ...
    async function getDms(){
            const url = "http://127.0.0.1:8000/dms"
    ...
    async function getAllFriends(){
            const url = "http://127.0.0.1:8000/friends"
                    let requestOptions = {
                        method: 'GET',
                        headers:{'Content-Type': 'application/json',"Authorization":"Bearer " + token}
                    }
   ...
   async function deleteFriend(event,user){
        ...
        const url = "http://127.0.0.1:8000/friend"
        const requestOptions = {
            method: 'DELETE',
            headers:{'Content-Type': 'application/json',"Authorization":"Bearer " + token},
    ...
    async function getServers(){
            const url = "http://127.0.0.1:8000/servers"
            const requestOptions = {
                  method: 'GET',
                  headers:{'Content-Type': 'application/json',"Authorization":"Bearer " + token},
            }
    ...
    async function getServerUsers(id){
            const url = "http://127.0.0.1:8000/server/users/" + id
            const requestOptions = {
                  method: 'GET',
                  headers:{'Content-Type': 'application/json',"Authorization":"Bearer " + token},
            }
